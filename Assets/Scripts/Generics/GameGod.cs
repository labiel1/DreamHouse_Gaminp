...
public class GameGod : MonoBehaviour {
	...
	public GameObject PlayerObjeto;		// Player object
	public GameObject BeeEnemy;		// Bee Enmy reference
	public GameObject WalkingBall;  // walking ball reference
    public GameObject InimigoTerrestre;  // walking ball reference
    public GameObject InimigoAereo;	// walking ball reference
	...
	private GameObject currentPlayerAtual;
	private GameObject[] enemies;
    //private PlayerController megaManContoller;
	...
	public void CallGodToRespawn(){
		...
		currentPlayerAtual = GameObject.FindGameObjectWithTag("Player");
		//megaManContoller = currentPlayerAtual.GetComponent<PlayerController>();
		enemies = GameObject.FindGameObjectsWithTag("Enemy");

		//Camera.main.transform.position = new Vector3(5.5f,-0.03373f,-10f);
		// Destroys the mega man
		//Destroy(currentPlayerAtual);
	...
	void SpawnAllEnemeies(){
		...
		RegionInstantiate(enemyNumReg1, 5f, 15f, 0.8f, 1.8f);		// values found by testing
